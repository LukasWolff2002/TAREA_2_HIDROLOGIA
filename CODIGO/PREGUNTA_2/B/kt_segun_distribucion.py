...
df_probabilidad_exc['Kt Normal'] = (df_probabilidad_exc['ACCESS1-0 [r1i1p1]'] - media) / desviacion_std
...
df_probabilidad_exc['Kt Pearson III'] = (df_probabilidad_exc['ACCESS1-0 [r1i1p1]'] - media) / desviacion_std
...
df_probabilidad_exc['Kt Gumbel'] = (df_probabilidad_exc['ACCESS1-0 [r1i1p1]'] - media_gumbel) / desviacion_std_gumbel
